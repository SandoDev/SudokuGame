    ...
    for i in range(9):  # una por cada numero diferente en un sudoku
        ...
        while row <= 8:  # una por cada FILA del sudoku
            ...
            if row == 5 or row == 2: 
                ...
                for_partially_bloqued[0] = discarded_column(row, number, sudoku)
                for_partially_bloqued[1] = discarded_column(row-1,number,sudoku)
            ...
            if column not in discarded[row] and \
                ...
                for value in values[row]:
                    ...
                    if column not in discarded[row] and \
                        ...
                        #     pass
                        # else:
                        discarded[row-1].append(column_discared) # descartar la COLUMNA utilizada en la iteración anterior de este NUMERO
